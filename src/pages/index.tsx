      ...
      <AnimatePresence>
        {showScrollTop && (
          <motion.button
            ...
            whileTap={{ scale: 0.9 }}
            onClick={scrollToTop}
            className="fixed bottom-8 right-8 z-50 p-3 rounded-full bg-purple-500/20 backdrop-blur-sm border border-purple-500/20 shadow-lg hover:bg-purple-500/30 transition-all duration-300 group"
          >
            <svg
              className="w-6 h-6 text-purple-200 transform transition-transform duration-300 group-hover:-translate-y-1"
              fill="none"
              strokeLinecap="round"
              strokeLinejoin="round"
              strokeWidth="2"
